...
import type { FilterParams, RootState } from "@/types";
...
function ShoppingListing() {
  ...
  // Fixed function with proper typing
  function handleFilter(getSectionId: string, getCurrentOption: string): void {
  ...
  useEffect(() => {
    ...
    // Fixed sessionStorage parsing with proper error handling
    try {
